...
lastName = 'Schmedtmann';//GLOBAL OBJECT
...
const bill = 275;
let tip;
console.log(`The bill was ${bill}, the tip was ${bill <= 300 && bill >= 50? tip = bill/100*15 : tip = bill/100*20}, and the total value ${bill + tip}`)
